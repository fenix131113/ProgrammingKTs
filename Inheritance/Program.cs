...
class Program
{
    static void Main(string[] args)
    {
        ...
        Console.WriteLine(new Rectangle(2, 2 ,2, 2, 15).CountArea());
        Console.WriteLine(new Rectangle(2, 2 ,2, 2, 15).CountPerimeter());
        Console.WriteLine(new Rhomb(2, 2 ,2, 2, 15).CountArea());
        Console.WriteLine(new Rhomb(2, 2 ,2, 2, 15).CountPerimeter());
        Console.WriteLine(new Square(2, 2 ,2, 2, 15).CountArea());
        Console.WriteLine(new Square(2, 2 ,2, 2, 15).CountPerimeter());
